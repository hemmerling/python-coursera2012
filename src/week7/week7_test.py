...
from spaceship import ImageInfo
from spaceship import Ship
from spaceship import Sprite
from spaceship import SpaceShipGame

#from spaceship import ship_image
...
class SpaceShipGame_initTest(unittest.TestCase):
    ...
    def testInit(self):
        assert self.spaceship.init() == None, 'SpaceShipGame.init() does not provide the right return value'

class SpaceShipGame_angleToVectorTest(unittest.TestCase):
    ...
    def testAngle_ToVector(self):
        vector = [1, 0]
        assert self.spaceship.angle_to_vector(0) == vector, 'SpaceShipGame.angle_to_vector() does not provide the right return value'

class SpaceShipGame_distTest(unittest.TestCase):
    ...
    def testDist(self):
        ...
        b = [0, 0]
        dist = 1
        assert self.spaceship.dist(a,b) == dist, 'SpaceShipGame.init() does not provide the right return value'

class SpaceShipGame_drawTest(unittest.TestCase):
    ...
    def testDraw(self):
        canvas = Canvas()
        assert self.spaceship.draw(canvas) == None, 'SpaceShipGame.draw() does not provide the right return value'

class SpaceShipGame_rockSpawnerTest(unittest.TestCase):
    ...
    def testRockSpawner(self):
        assert self.spaceship.rock_spawner() == None, 'SpaceShipGame.rock_spawner() does not provide the right return value'

class SpaceShipGame_mainTest(unittest.TestCase):
    ...
    def testMain(self):
        assert self.spaceship.main() == None, 'SpaceShipGame.main() does not provide the right return value'
